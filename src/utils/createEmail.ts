...
export const createEmail = ({ mode, userEmail, url }: ICreateEmail) => {
  ...
  const intro =
    mode === "verify"
      ? "Добро пожаловать в ГРАНДБАЗАР! Чтобы завершить регистрацию и начать покупки, подтвердите ваш email:"
      : "Получен запрос на восстановление пароля для вашего аккаунта в ГРАНДБАЗАР. Чтобы установить новый пароль, перейдите по ссылке:"
