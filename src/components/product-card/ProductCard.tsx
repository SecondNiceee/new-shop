...
export function ProductCard({ product }: IProductCard) {
  ...
  return (
    <Card
      ...
      className="p-4 cursor-pointer bg-gray-100 rounded-lg gap-2 shadow-sm border border-gray-100 hover:shadow-md transition-shadow"
    >
      {/* Product Image */}
      ...
      <div className="mb-4 gap-2 flex flex-col">
        ...
        {product.averageRating && product.averageRating > 0 && (
          <StarRating rating={product.averageRating} size="sm" reviewsCount={product.reviewsCount as number} className="mt-1" />
        )}
      </div>
